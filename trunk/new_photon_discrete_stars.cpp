...

{
  ...
  if (geometry.num_stars > 1) {
    ...
    while ((i < geometry.num_stars) && (ran_num > geometry.star_positions[4][i])) i++;
    pos_index = i;
//     cout << "random # = " << ran_num << endl;
//     cout << "geometry.star_positions = " << geometry.star_positions[4][i-1];
//     cout << " " << geometry.star_positions[4][i] << endl;
//     exit(8);
  }
