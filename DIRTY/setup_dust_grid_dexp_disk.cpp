                    ...
                    for (j = 0; j < geometry.grids[m].index_dim[1]; j++)
                        {
                            ...
                            for (i = 0; i < geometry.grids[m].index_dim[0]; i++)
                                {
                                    x_val = (geometry.grids[m].positions[0][i] + geometry.grids[m].positions[0][i + 1])
                                            / 2.0;
                                    float xy_val = sqrt (x_val * x_val + y_val * y_val);
                                            ...
                                            for (o = 0; o < subgrid.index_dim[2]; o++)
                                                {
                                                    ...
                                                    for (n = 0; n < subgrid.index_dim[1]; n++)
                                                        {
                                                            ty_val = (subgrid.positions[1][n]
                                                                      + subgrid.positions[1][n + 1])
                                                                     / 2.0;
                                                            for (l = 0; l < subgrid.index_dim[0]; l++)
                                                                {
                                                                    tx_val = (subgrid.positions[0][l]
                                                                              + subgrid.positions[0][l + 1])
                                                                             / 2.0;
                                                                    float txy_val
                                                                        = sqrt (tx_val * tx_val + ty_val * ty_val);
                                                                    tmp_density
                                                                        = tmp_den_constant
