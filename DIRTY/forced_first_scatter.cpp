...

{
    ...
    distance_traveled
        = calc_photon_trajectory (dummy_photon, geometry, target_tau, target_dist, ffs_escape, tau_to_surface, 0);
    ...
    if (tau_to_surface == 0.0)
    ...
    else
        {
            ...
            biased_weight_factor
                = (1.0 - geometry.scat_bias_fraction)
...
#endif
            distance_traveled
                = calc_photon_trajectory (photon, geometry, target_tau, target_dist, escape, tau_traveled, 0);
