...

{
  ...
  if (tau_to_surface == 0.0)
  ...
  else
    {
      ...
      //   } else {
      //     // This is a special case where the photon has traveled the correct
      //     distance
      //     // but has also just exited a subgrid.  This means that the photon
      //     index
      //     // for the subgrid is below or above the actual subgrid size for one
      //     dimension.
      ...
      // 	cout << "m = " << m << " ";
      // 	cout << "tmp_photon.position_index = " << photon.position_index[k][m] <<
      // endl;
      //       }
      //     }
        ...
        for (int i = 0; i < dummy_photon.path_cur_cells; i++)
          {
            ...
            if (this_cell.last_photon_number != photon.number)
            ...
            else
              {
                ...
                // have a special step at the end to add the total photon's
                // contribution
