...
int forced_first_scatter(geometry_struct &geometry, photon_data &photon, random_dirty &random_obj)

{
    ...
    else
    {
        ...
        biased_weight_factor = (1.0 - geometry.scat_bias_fraction) + geometry.scat_bias_fraction *
                                                                         (1.0 - exp(-photon.first_tau)) *
