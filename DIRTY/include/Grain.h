...
class Grain {  // Begin Grain Class definition
 ...
 public:
  ...
  void MakeGrain(string const &fOpticalConstants, string const &fCalorimetry,
                 vector<float> &MasterWave, vector<float> &MasterSize,
                 string const &Path, float a_min = -1, float a_max = -1);
