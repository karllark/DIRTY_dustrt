...
struct runinfo_struct
{
  ...
  double total_absorbed_stellar_energy; // total absorbed energy from the very first RT, for use
                                        // with energy_conserve_target2
  ...
  int out_sed_lum_offset; // offset for vector to all for ERE/Dust direct/scattered to be saved as
                          // well as stellar direct/scattered
