...
extern void setup_dust_grid(ConfigFile &param_data, geometry_struct &geometry,
                            photon_data &photon, random_dirty &random_obj);

// do the radiative transfer over all the wavelengths
extern void radiative_transfer_many_waves(
    geometry_struct &geometry, runinfo_struct &runinfo, output_struct &output,
