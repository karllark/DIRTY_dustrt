...
extern void get_run_parameters (ConfigFile &param_data, output_struct &output,
                                geometry_struct &geometry, runinfo_struct &runinfo);

// get the dust parameters
extern void get_dust_parameters (ConfigFile &param_data, GrainModel &CurGrainModel,
                                 geometry_struct &geometry, runinfo_struct &runinfo);

// ger the sed parameters
extern void get_sed_parameters (ConfigFile &param_data, runinfo_struct &runinfo,
...
extern void radiative_transfer_many_waves (geometry_struct &geometry, runinfo_struct &runinfo,
                                           output_struct &output, photon_data &photon,
                                           random_dirty &random_obj, int rt_type, int iter_num);
...
extern void get_dust_thermal_emission (geometry_struct &geometry, runinfo_struct &runinfo,
                                       GrainModel &CurGrainModel, DirtyFailure *Failure);

// setup for the thermal dust emission output (used for separate grain/emission
// output)
extern void setup_thermal_dust_emission_output (runinfo_struct &runinfo, output_struct &de_output,
                                                output_struct &output, photon_data &photon);
...
extern void output_global_results (runinfo_struct &runinfo, output_struct &output,
                                   geometry_struct &geometry);

// output the model grid
extern void output_model_grid (geometry_struct &geometry, output_struct &output,
