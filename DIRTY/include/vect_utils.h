...
// Overload of operator()
template <typename T>
inline T &Tensor<T>::operator()(int n1_id, int n2_id, int n3_id) {
  if (n1_id < 0 || n1_id >= _n1) {
...
inline T &FourVector<T>::operator()(int n1_id, int n2_id, int n3_id,
  ...
  if (n4_id < 0 || n4_id >= _n4) {
    ...
    std::string ExceptionObject =
        "out_of_range FourVector::operator(), element 4";
    throw std::out_of_range(ExceptionObject);
  }
...
// Overload of operator()
template <typename T>
inline T &FiveVector<T>::operator()(int n1_id, int n2_id, int n3_id, int n4_id,
                                    int n5_id) {
  // thows not working... do it the "clutz way".
  if (n1_id < 0 || n1_id >= _n1) {
    cout << "out_of_range FiveVector::operator(), element 1" << endl;
    std::string ExceptionObject =
        "out_of_range FiveVector::operator(), element 1";
    throw std::out_of_range(ExceptionObject);
  }
  if (n2_id < 0 || n2_id >= _n2) {
    cout << "out_of_range FiveVector::operator(), element 2" << endl;
    std::string ExceptionObject =
        "out_of_range FiveVector::operator(), element 2";
    throw std::out_of_range(ExceptionObject);
  }
  if (n3_id < 0 || n3_id >= _n3) {
    cout << "out_of_range FiveVector::operator(), element 3" << endl;
    std::string ExceptionObject =
        "out_of_range FiveVector::operator(), element 3";
    throw std::out_of_range(ExceptionObject);
  }
  if (n4_id < 0 || n4_id >= _n4) {
    cout << "out_of_range FiveVector::operator(), element 4" << endl;
    std::string ExceptionObject =
        "out_of_range FiveVector::operator(), element 4";
    throw std::out_of_range(ExceptionObject);
  }
  if (n5_id < 0 || n5_id >= _n5) {
    cout << "out_of_range FiveVector::operator(), element 5" << endl;
    std::string ExceptionObject =
        "out_of_range FiveVector::operator(), element 5";
    throw std::out_of_range(ExceptionObject);
  }
  return *(this->begin() + n5_id * _n1 * _n2 * _n3 * _n4 +
           n4_id * _n1 * _n2 * _n3 + n3_id * _n1 * _n2 + n2_id * _n1 + n1_id);
}

// Size the FiveVector after instatiation, make zero size.
template <typename T>
void FiveVector<T>::FiVSize(int n1_id, int n2_id, int n3_id, int n4_id,
                            int n5_id) {
  _n1 = n1_id;
  _n2 = n2_id;
  _n3 = n3_id;
