...
FourVector<T>::operator() (int n1_id, int n2_id, int n3_id, int n4_id)
{
    if (n1_id < 0 || n1_id >= _n1)
        {
            cout << "out_of_range FourVector::operator(), element 1 " << n1_id << "," << n2_id << "," << n3_id << " "
                 << n4_id << " " << _n1 << endl;
    ...
    if (n2_id < 0 || n2_id >= _n2)
        {
            cout << "out_of_range FourVector::operator(), element 2 " << n1_id << "," << n2_id << "," << n3_id << " "
                 << n4_id << " " << _n2 << endl;
    ...
    if (n3_id < 0 || n3_id >= _n3)
        {
            cout << "out_of_range FourVector::operator(), element 3 " << n1_id << "," << n2_id << "," << n3_id << " "
                 << n4_id << " " << _n3 << endl;
    ...
    if (n4_id < 0 || n4_id >= _n4)
        {
            cout << "out_of_range FourVector::operator(), element 4 " << n1_id << "," << n2_id << "," << n3_id << " "
                 << n4_id << " " << _n4 << endl;
            std::string ExceptionObject = "out_of_range FourVector::operator(), element 3";
            throw std::out_of_range (ExceptionObject);
        }
