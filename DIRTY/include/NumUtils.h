...
template <typename T>
vector<T> interpol (vector<T> &v, vector<T> &x, vector<T> &u, int LoEx = 2, int HiEx = 2);
template <typename T>
void interpolr (vector<T> &v, vector<T> &x, vector<T> &u, int LoEx = 2, int HiEx = 2);
...
template <typename T>
vector<T> poly_fit (vector<T> x, vector<T> y, int ndegree, vector<T> &yfit, vector<T> &sigma);
