...
class GrainModel : protected Grain
{
  public:
    ...
    /*   } */
    inline vector<float> getCAbsEff(void)
    {
        return CAbsEff;
    }
    ...
    inline vector<float> getCScaEff(void)
    {
        return CScaEff;
    }
    inline vector<float> getAlbedo(void)
    {
        return Albedo;
    }
    inline vector<float> getphFuncEff(void)
    {
        return phFuncEff;
    }
    ...
    inline vector<float> getEScale(void)
    {
        return EScale;
    }

    float getTau(float a_wave);
    inline vector<float> getTau(void)
    {
        return Tau;
    }
    inline float getMDust(int cmp)
    {
        return DustMass[cmp];
    }
    inline float getVDust(int cmp)
    {
        return DustVolume[cmp];
    }
    inline float getMDust(void)
    {
        return TotalDustMass;
    }

    inline float getNumber(int cmp)
    {
        return number[cmp];
    }
    ...
    inline float getNormalization(void)
    {
        return TotalNormalization;
    }
    inline float getNormalization(int cmp)
    {
        return Normalization[cmp];
    }
    ...
    //   - Need bound checking
    //
    inline vector<float> Size(int _cmp)
    {
    ...
    inline int nSize(int _cmp)
    {
        return Component[_cmp].getNSize();
    }
    inline float Density(int _cmp)
    {
    ...
    inline string getModelName(void)
    {
        return ModelName;
    }

    inline float getDustToGasMassRatio(void)
    {
        return DustToGasMassRatio;
    }
    inline float getMeanMolecularWeight(void)
    {
