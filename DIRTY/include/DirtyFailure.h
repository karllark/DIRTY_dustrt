...
class DirtyFailure
{
  ...
  public:
    ...
    inline string
    getFailureDescription (int _flag)
    {
    ...
    inline int
    getFailureFlag (string _description)
    {
        bool _found = false;
        mIter = FlagMap.begin ();
    ...
    inline void
    AddCellBook (int &_maxis, int &_iaxis, int &_jaxis, int &_kaxis)
    {
    ...
    inline void
    AddGrainInfo (string _GrainModelName, float &_GrainSize, int &_GrainComponent)
    {
    ...
    inline void
    AddEnergyInfo (double &_AbsorbedEnergy, vector<float> &_RadiationField)
    {
