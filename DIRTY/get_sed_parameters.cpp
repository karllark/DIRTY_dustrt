...
void get_sed_parameters(ConfigFile &param_data, runinfo_struct &runinfo, GrainModel &CurGrainModel)
    ...
    else
    {
        ...
        if (mapping_bin == 1)
        {
            ...
            for (i = 0; i < luminosity.size(); i++)
            {
                ...
                {
                    closeIter = find_if(runinfo.wavelength.begin(), runinfo.wavelength.end(),
