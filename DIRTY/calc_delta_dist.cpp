...
double
calc_delta_dist (photon_data &photon, geometry_struct &geometry, double target_tau,
...
#endif
  double dust_tau_ref_per_pc = geometry.grids[grid_val]
          ...
          if (photon.number == OUTNUM)
            {
              ...
              cout << geometry.grids[photon.grid_number[photon.current_grid_num]].grid.nCol ()
                   << " ";
              cout << geometry.grids[photon.grid_number[photon.current_grid_num]].grid.n3rd ()
                   << endl;
            }
#endif
        }
