...
void
setup_dust_grid_slab (ConfigFile &param_data, geometry_struct &geometry, random_dirty &random_obj)
          ...
          for (i = 0; i < main_grid.index_dim[0]; i++)
            {
              ...
              // slab position should be a negative z if behind stars (observer
              // at positive z)
