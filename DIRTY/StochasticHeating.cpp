...
int
StochasticHeating (vector<float> &wave, vector<float> &cJprod, vector<float> &cabs, vector<float> &Temperature,
...
int
ComputeTransitionMatrix (vector<vector<double> > &TM, vector<float> &wave, vector<float> &temp, vector<float> &enth,
                         vector<float> &cabs, vector<float> &cJprod, vector<float> &denth, int &nBins)
{
