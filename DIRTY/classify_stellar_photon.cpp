...
void
classify_stellar_photon (output_struct &output, photon_data &photon, geometry_struct &geometry,
          ...
          if (photon.number == OUTNUM)
            {
              ...
              cout << "classify_stellar_photon: stellar_weight = " << tmp_photon.stellar_weight
                   << endl;
            }
#endif
                  ...
                  if ((image_indxs[k] < 0) || (image_indxs[k] > (output.image_size[k] - 1)))
                    {
                      ...
                      cout << "real version of index = "
                           << (1.0 + (angle / geometry.angular_radius)) * output.image_size[k] * 0.5
                           << endl;
                      exit (8);
                    }
                }
