...
void setup_thermal_dust_emission_output(runinfo_struct &runinfo, output_struct &de_output, output_struct &output,
                                        photon_data &photon)

{
    ...
    de_output.emission_type = "_de"; // setup the emission_type string for dust emission
