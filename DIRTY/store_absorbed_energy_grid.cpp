...
void
store_absorbed_energy_grid (geometry_struct &geometry, runinfo_struct &runinfo, output_struct &output, int index,
                            int doing_emission)
                            ...
                            for (i = 0; i < geometry.grids[m].index_dim[0]; i++)
                                {
                                    ...
                                    if (geometry.grids[m].grid (i, j, k).dust_tau_per_pc > 0.0)
                                        {
                                            ...
                                            geometry.grids[m].grid (i, j, k).num_H
                                                = num_H_const * vol * geometry.grids[m].grid (i, j, k).dust_tau_per_pc
                                    ...
                                    if ((geometry.grids[m].grid (i, j, k).dust_tau_per_pc > 0.0)
                                        ...
                                        {
#ifdef DEBUG_SAEG
                                            cout << "dust tau/pc = " << geometry.grids[m].grid (i, j, k).dust_tau_per_pc
                                                 << endl;
                                            ...
                                            double j_temp = geometry.grids[m]
                                                                .grid (i, j, k)
                                                                .absorbed_energy[geometry.abs_energy_wave_index];
                                            double j_temp_x2 = geometry.grids[m]
                                                                   .grid (i, j, k)
