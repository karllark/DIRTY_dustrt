  ...
  while (not done) {
    ...
    for (i = 0; i < 3; i++) {
      ...
      if (photon.number == OUTNUM) {
        ...
        cout << "grid min = " << geometry.grids[cur_grid_num].positions[i][0]
             << endl;
        // cout << "grid size = " <<
      ...
      while ((k2 - k1) > 1) {
        ...
        if (photon.position[i] <
            geometry.grids[cur_grid_num].positions[i][mid_k])
          k2 = mid_k;
        else
          k1 = mid_k;
        // cout << k1 << " " << k2 << endl;
      ...
      if (photon.number == OUTNUM) {
        ...
        cout << "photon.position_index[k][i] = " << photon.position_index[k][i]
             << endl;
      ...
      if ((photon.position[i] <
        ...
        if (not_ok) {
          ...
          cout << "photon.position_index[k][i] = "
               << photon.position_index[k][i] << endl;
          cout << "tmp_save_pindex = " << tmp_save_pindex << endl;
          // cout << "real value of pindex = " << (photon.position[i] -
          // geometry.grids[cur_grid_num].positions[i][0])/
          //   geometry.grids[cur_grid_num].phys_cube_size[i] << endl;
    ...
    if (geometry.grids[cur_grid_num]
            ...
            .dust_tau_per_pc <= -1.0) {
      cur_grid_num = -int(geometry.grids[cur_grid_num]
                              .grid(photon.position_index[k][0],
