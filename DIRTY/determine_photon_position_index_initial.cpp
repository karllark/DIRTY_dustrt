...
void
determine_photon_position_index_initial (geometry_struct &geometry, photon_data &photon)
          ...
          if (photon.number == OUTNUM)
            {
              ...
              // (determine_photon.position_index_initial.cpp)." << endl;
              ...
              cout << "geometry.grids[cur_grid_num].positions[i][0] = " << geometry.grids[cur_grid_num].positions[i][0]
                   << endl;
              ...
              if (not_ok)
                {
                  ...
                  // cout << "geometry.grids[cur_grid_num].phys_cube_size[i] =
                  // " << geometry.grids[cur_grid_num].phys_cube_size[i] <<
                  // endl; cout << "min edge diff/cube size = " <<
                  // (geometry.grids[cur_grid_num].positions[i][photon.position_index[k][i]]
                  // - photon.position[i])/
