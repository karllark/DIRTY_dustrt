...
void determine_photon_position_index(geometry_struct &geometry, photon_data &photon)
        ...
        for (i = 0; i < 3; i++)
        {
                 ...
                 geometry.grids[cur_grid_num].positions[i][geometry.grids[cur_grid_num].index_dim[i]]))
            {
                ...
                if (photon.position[i] < geometry.grids[cur_grid_num].positions[i][0])
                {
                    ...
                    cout << "frac_miss-- = " << frac_miss << "; photon # = " << photon.number << endl;
                ...
                if (not_ok)
                {
                    ...
                    cout << geometry.grids[cur_grid_num].positions[i][geometry.grids[cur_grid_num].index_dim[i]]
                         << endl;
