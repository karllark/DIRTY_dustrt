...
public:
  ...
  inline vector<float>
  getSizeDistribution (int _cmp)
  {
    return SizeDistribution[_cmp];
  }
  inline vector<float>
  getSizeDistributionNorm (int _cmp)
  {
  ...
  inline float
  getNormalization (void)
  {
    return TotalNormalization;
  }
  inline float
  getNormalization (int cmp)
  {
  ...
  inline vector<float>
  CAbs (int _cmp, float _sz)
  {
    return Component[_cmp].getCAbs (_sz);
  }
  inline vector<float>
  CSca (int _cmp, float _sz)
  {
    return Component[_cmp].getCSca (_sz);
  }
  inline vector<float>
  wCAbs (int _cmp, int _wid)
  {
  ...
  inline float
  getDustToGasMassRatio (void)
  {
    return DustToGasMassRatio;
  }
  inline float
  getMeanMolecularWeight (void)
  {
