...
public:
  ...
  inline string getComponentName( int cmp) { return Component[cmp].getComponentName(); }

  // Return the filename of the optical constants for the specified component
  inline string getOpticalFilename( int cmp) { return Component[cmp].getOpticalFilename(); }
...
/*   } */
  ...
  inline vector <float> CSca ( int _cmp, int _szid ) { return Component[_cmp].getCSca(_szid); }
  ...
  inline vector <float> CSca ( int _cmp, float _sz ) { return Component[_cmp].getCSca(_sz); }
