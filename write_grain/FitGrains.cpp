...
int FitGrains::nWave(int cmp) { return Component[cmp].getNWave(); }

int FitGrains::getNComp(void) { return nComp; }

string FitGrains::getModelName(void) { return ModelName; }
...
int FitGrains::nSize(int _cmp) { return Component[_cmp].getNSize(); }

vector<float> FitGrains::Size(int _cmp) { return Component[_cmp].getSize(); }
...
float FitGrains::Density(int _cmp) { return Component[_cmp].getDensity(); }
