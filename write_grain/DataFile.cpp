...
// Two column
DataFile::DataFile(string const& dataFile, vector<double>&v1, vector<double>&v2) {
...
// Three column
DataFile::DataFile(string const& dataFile, vector<double>&v1, vector<double>&v2, vector<double>&v3) {
...
// Four column
DataFile::DataFile(string const& dataFile, vector<double>&v1, vector<double>&v2, vector<double>&v3, vector<double>&v4) {
...
DataFile::DataFile(string const& dataFile, vector<double>&v1, vector<double>&v2, vector<double>&v3, vector<string>&v4) {
...
// Five column
DataFile::DataFile(string const& dataFile, vector<double>&v1, vector<double>&v2, vector<double>&v3, vector<double>&v4, vector<double>&v5) {
...
DataFile::DataFile(string const& dataFile, vector<double>&v1, vector<double>&v2, vector<double>&v3, vector<double>&v4, vector<string>&v5) {
