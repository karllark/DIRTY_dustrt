      ...
      for (int j = 0; j < nSize; ++j)
        {
          ...
          for (int jj = 0; jj < nISRFs; jj++)
            {
              ...
              status = ComputeDustEmission_igrain (
                  ...
                  FitGrainDefines.getModelName (), FitGrainDefines.ComponentName (i), i,
                  sizevals[j], j, RadiationFieldType, RadiationFieldScale[jj],
          ...
          myfile << "# Ratio of heating to cooling to determine stochastic cutoff: " << TauScaling
                 << endl;
