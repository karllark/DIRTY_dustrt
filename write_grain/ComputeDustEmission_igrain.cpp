...
int
ComputeDustEmission_igrain (vector<float> &J, vector<float> &CAbs, vector<float> &Wave, vector<float> &Enthalpy,
                            vector<float> &CalorimetryTGrid, vector<double> &EquilibriumEmission,
                            vector<double> &StochasticEmission, float &TauHeating, float &TauCooling, float &TauScaling,
                            bool &StochasticallyHeated, string ModelName, string ComponentName, int ComponentIndex,
                            float Size, int SizeIndex, string RadiationFieldType, float RadiationFieldScale,
    ...
    if (StochasticallyHeated)
        {
            ...
            pdistStream << "# Component, Size Index, Size: " << ComponentName << " " << SizeIndex << " " << Size
                        << endl;
